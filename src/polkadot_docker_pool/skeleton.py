...
``[options.entry_points]`` section in ``setup.cfg``::
    ...
    console_scripts =
         genz-polkadot-pool = polkadot_docker_pool.skeleton:run
...
from polkadot_docker_pool import __version__
import polkadot_docker_pool.config_cli as config_cli
import polkadot_docker_pool.relay_cli as relay_cli
import polkadot_docker_pool.staking_cli as staking_cli
import polkadot_docker_pool.wallet_cli as wallet_cli
...
if __name__ == "__main__":
    ...
    #
    #     python -m polkadot_docker_pool.skeleton 42
    #
    run()
